/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 22baf29b6b46814c6c68b0e5742cb09c)
// Runtime types generated with workerd@1.20260701.1 2026-06-03 nodejs_als,nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	ASSETS: Fetcher;
	BACKUP_WORKER_URL: "https://todai-league-backup.qwg2pfmvzk.workers.dev";
	BETTER_AUTH_URL: string;
	BETTER_AUTH_SECRET: string;
	LiveBoard: DurableObjectNamespace<import("./src/worker").LiveBoard>;
	MatchActionCoordinator: DurableObjectNamespace<import("./src/worker").MatchActionCoordinator>;
	BACKUP_WORKER: Fetcher /* todai-league-backup */;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "LiveBoard" | "MatchActionCoordinator";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BACKUP_WORKER_URL" | "BETTER_AUTH_URL" | "BETTER_AUTH_SECRET">> {}
}
