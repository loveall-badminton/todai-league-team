<script lang="ts">
	...
	let {
		...
		allTeams,
		tieForm
	}: { tie: TieRow; index: number; allTeams: Team[]; tieForm: Record<string, unknown> } = $props();
...
>
	<Collapsible.Root>
		<div class="flex items-stretch">
			...
			<Collapsible.Trigger
				class="group/tie flex flex-1 items-start justify-between gap-4 px-4 py-4 text-left"
			>
